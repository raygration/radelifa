...
//add_action( 'the_content', array( $this, 'end_query' ) );
	...
	function default_message() {
		...
		if ( !empty( $message ) && !empty( $page_id ) ) {
			...
			$message .= '<button  style="margin-bottom: 5px;" type="button" class="button assign-listing-button">' . __( 'Yes', 'ecommerce-product-catalog' ) . '</button><div class="ic_spinner"></div>';
